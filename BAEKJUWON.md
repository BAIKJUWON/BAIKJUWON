...
![상단 이미지](https://capsule-render.vercel.app/api?type=waving\&color=0:1428A0,50:0A3D91,100:111827\&height=220\&section=header\&text=JUWON%20BAIK\&fontSize=52\&fontColor=FFFFFF\&fontAlignY=38\&desc=Embedded%20System%20Developer\&descAlignY=59\&descSize=18)

## 하드웨어와 소프트웨어를 연결하는 개발자 백주원입니다.

마이크로컨트롤러와 리눅스를 기반으로
하드웨어를 직접 제어하는 임베디드 시스템을 개발하고 있습니다.

단순한 기능 구현을 넘어 장치, 통신, 운영체제를 이해하고
**안정적으로 동작하는 시스템을 만드는 개발자**를 목표로 합니다.
...
```text
이름       백주원
주요 분야  임베디드 시스템 · 마이크로컨트롤러 · 리눅스
주요 언어  C · C++ · Python
주요 장치  Arduino · Raspberry Pi · Raspberry Pi Pico · STM32
개발 방향  하드웨어와 소프트웨어를 연결하는 시스템 구현
```

전자회로와 마이크로컨트롤러를 기반으로
센서 데이터를 수집하고 주변 장치를 제어하는 프로젝트를 개발해 왔습니다.

아두이노, 라즈베리파이, 라즈베리파이 피코와 STM32를 활용한
임베디드 시스템 개발 역량을 키우고 있으며,
리눅스 환경에서 장치와 프로그램을 제어하는 과정에도 관심이 있습니다.

웹 개발과 보안 분야도 프로젝트와 해커톤을 통해 경험했지만,
현재는 **C·C++ 기반 임베디드 시스템 개발**을 중심으로 공부하고 있습니다.
...
* 하드웨어 연결 및 회로 문제 확인
* 라이브러리와 개발 보드 간 호환성 분석
* 직렬 통신을 활용한 실행 상태 점검
* 기능 단위 테스트를 통한 오류 원인 분리
* 센서 측정값과 장치 동작 오류 개선
* 반복적인 코드 수정과 시스템 안정화
...
* **주요 환경:** 우분투
* **보조 환경:** 센트오에스
* 리눅스 명령어, 파일 관리, 권한 설정, 컴파일 환경 활용
* 서버 및 네트워크 기초 환경 구성 경험
...
웹 개발과 보안은 전문 분야보다는
임베디드 장치 연동, 해커톤 및 프로젝트 구현을 위한 수준으로 경험했습니다.

* 플라스크 기반 간단한 웹 서버 구현
* 웹 화면을 활용한 장치 상태 확인 및 제어
* 데이터베이스를 활용한 데이터 저장
* 생성형 인공지능을 활용한 C 언어 코드 취약점 분석 경험
* 기본적인 프론트엔드 화면 구성
...
* 플라스크 기반 웹 서버 구현
* 사용자 코드 입력 및 분석 결과 출력
* 생성형 인공지능 응용 프로그램 인터페이스 연동
* C 언어 코드 취약점 분석
* 대학 연합 해커톤 인기상 수상
...
[![시스템 구성 보기](https://img.shields.io/badge/System-Sys.md-1428A0?style=for-the-badge\&logo=windows\&logoColor=white)](https://github.com/BAIKJUWON/BAIKJUWON/blob/main/Sys.md)

<br><br>

<img src="https://img.shields.io/badge/AMD-Ryzen%209%207950X-ED1C24?style=for-the-badge&logo=amd&logoColor=white">
<img src="https://img.shields.io/badge/NVIDIA-RTX%203080-76B900?style=for-the-badge&logo=nvidia&logoColor=white">

<br>

<img src="https://img.shields.io/badge/Apple-MacBook%20Pro%202020-000000?style=for-the-badge&logo=apple&logoColor=white">
<img src="https://img.shields.io/badge/Windows-LG%20gram-0078D4?style=for-the-badge&logo=windows&logoColor=white">
...
### 기본에 충실한 코드와 안정적으로 동작하는 시스템을 만들겠습니다.

![하단 이미지](https://capsule-render.vercel.app/api?type=waving\&color=0:1428A0,50:0A3D91,100:111827\&height=110\&section=footer)
